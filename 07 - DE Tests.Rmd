...
rownames(ugly)<-c("BetweenMix","ERCC M1 vs M2", "SIRV E2 vs E1","SIRV E1 vs None","SIRV E2 vs None", "MixM::SIRVE2","MixLM::SIRVE2","MixLM::noSIRV")
ugly[,c(3,1,2,4,6,5)]
```
...
ggplot(data=data.frame(LFC=res2$log2FoldChange,SV=transtype))+
