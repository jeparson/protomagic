...
p$task_add(app=p$app(name="mergecounts")$id,inputs=list(source_file=sampleglist,outputfilename=paste0(Labid,"Gene_Counts.csv"),Column=5,names=paste(gnames,collapse=","))) # Column 5 is the expected count value.  Again, specific to star/rsem.
p$task_add(app=p$app(name="mergecounts")$id,inputs=list(source_file=sampletlist,outputfilename=paste0(Labid,"Transcript_Counts.csv"),Column=5,names=paste(tnames,collapse=","))) 
